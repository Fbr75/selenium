...
public class baseclass {
	...
	System.setProperty("webdriver.chrome.driver", "C:\\Users\\mooni\\eclipse-workspace\\google2\\drivers\\chromedriver.exe");
	driver= new ChromeDriver();  // Opening chrome browser
		  }
		  
		  else if (brow.contains("firefox")) {
		    
	System.setProperty("webdriver.gecko.driver", "C:\\Users\\mooni\\eclipse-workspace\\google2\\drivers\\geckodriver.exe");
	driver= new FirefoxDriver();  // Opening firefox browser
		  }
		  else {
	System.setProperty("webdriver.edge.driver", "C:\\Users\\mooni\\eclipse-workspace\\google2\\drivers\\msedgedriver.exe");
